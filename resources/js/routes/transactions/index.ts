 ...
 */
    ...
    show.form = showForm
/**
* @see \App\Http\Controllers\TransactionController::manualConfirm
 * @see app/Http/Controllers/TransactionController.php:173
 * @route '/transactions/{transaction}/manual-confirm'
 */
export const manualConfirm = (args: { transaction: string | { id: string } } | [transaction: string | { id: string } ] | string | { id: string }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: manualConfirm.url(args, options),
    method: 'post',
})

manualConfirm.definition = {
    methods: ["post"],
 ...
 * @route '/transactions/{transaction}/manual-confirm'
 */
manualConfirm.url = (args: { transaction: string | { id: string } } | [transaction: string | { id: string } ] | string | { id: string }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { transaction: args }
    }
    ...
    return manualConfirm.definition.url
            .replace('{transaction}', parsedArgs.transaction.toString())
            .replace(/\/+$/, '') + queryParams(options)
}
 ...
 * @route '/transactions/{transaction}/manual-confirm'
 */
manualConfirm.post = (args: { transaction: string | { id: string } } | [transaction: string | { id: string } ] | string | { id: string }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: manualConfirm.url(args, options),
    method: 'post',
})
 ...
 * @route '/transactions/{transaction}/manual-confirm'
 */
    const manualConfirmForm = (args: { transaction: string | { id: string } } | [transaction: string | { id: string } ] | string | { id: string }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
        action: manualConfirm.url(args, options),
        method: 'post',
    })
 ...
 * @route '/transactions/{transaction}/manual-confirm'
 */
        manualConfirmForm.post = (args: { transaction: string | { id: string } } | [transaction: string | { id: string } ] | string | { id: string }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: manualConfirm.url(args, options),
            method: 'post',
        })
    
    manualConfirm.form = manualConfirmForm
const transactions = {
    index: Object.assign(index, index),
store: Object.assign(store, store),
show: Object.assign(show, show),
manualConfirm: Object.assign(manualConfirm, manualConfirm),
}
